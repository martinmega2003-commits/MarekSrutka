...
(function () {
  ...
  if (!wrap) return;
  armScrollReveal(wrap, Array.prototype.slice.call(wrap.querySelectorAll('.outcome')), { stagger: 80, threshold: 0.2 });
})();

/* kontaktní karty osob (jen na kontakt.html) */
(function () {
  var wrap = document.querySelector('.people');
  if (!wrap) return;
